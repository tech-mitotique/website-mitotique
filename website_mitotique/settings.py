"""
Django settings for website_mitotique project.
...
ROOT_URLCONF = 'website_mitotique.urls'
...
WSGI_APPLICATION = 'website_mitotique.wsgi.application'
...
# Media files (User uploaded Images only)
